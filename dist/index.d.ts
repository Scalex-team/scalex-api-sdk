...
interface IRetrieveWalletBalancesPayload {
...
interface IRetrieveWalletBalancesRes {
    balances: Array<IWalletBalance>;
}
declare const RetrieveWalletBalancesEndpoint: Endpoint;
...
declare class WalletsModule {
    ...
    retrieveWalletBalances(payload: IRetrieveWalletBalancesPayload, authToken: string): Promise<ScalexSuccessResponse<IRetrieveWalletBalancesRes>>;
}
