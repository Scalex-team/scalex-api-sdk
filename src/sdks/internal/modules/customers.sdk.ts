...
export class ScalexCustomersSdk {
  ...
  async requestOtpToRegister(
    payload: IRequestOtpToRegisterPayload
  ...
  async verifyOtpAndCreatePassword(
    payload: IVerifyOtpAndCreatePasswordPayload,
    authToken: string
  ...
  async verify2faToken(
    payload: IVerify2faTokenPayload,
    authToken: string
  ...
  async requestOtpToLogin(
    payload: IRequestOtpForLoginPayload
  ...
  async verifyOtpAndPasswordForLogin(
    payload: IVerifyOtpAndPasswordForLoginPayload,
    authToken: string
  ): Promise<ScalexSuccessResponse<ITokenWithUserResponse>> {
    return callApi<
      IVerifyOtpAndPasswordForLoginPayload,
  ...
  async verify2faForLogin(
    payload: IVerify2faForLoginPayload,
    authToken: string
  ): Promise<ScalexSuccessResponse<ILoginResponse>> {
  ...
  async initiateVerification(
    payload: IInitiateVerificationPayload,
    authToken: string
